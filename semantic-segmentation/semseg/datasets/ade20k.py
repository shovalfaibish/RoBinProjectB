...
class ADE20K(Dataset):
    ...
    # When training comment this, and label only one of them as white
    PALETTE[52] = torch.tensor([255, 255, 255])  # path
    # PALETTE[6] = torch.tensor([255, 255, 255])  # road
    # PALETTE[11] = torch.tensor([255, 255, 255])  # sidewalk
    # PALETTE[3] = torch.tensor([255, 255, 255])  # floor
    # PALETTE[91] = torch.tensor([255, 255, 255])  # dirt track
