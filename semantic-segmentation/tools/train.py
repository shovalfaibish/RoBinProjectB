...
def main(cfg, gpu, save_dir):
    ...
    iters_per_epoch = (len(trainset)//10 )// train_cfg['BATCH_SIZE']
    ...
    for epoch in range(epochs):
        ...
        for iter, (img, lbl) in pbar:
            ...
            if iter >= iters_per_epoch:
                break  # Stop iterating if we have reached the desired number of iterations per epoch
